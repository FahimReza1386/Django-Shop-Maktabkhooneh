# Generated by Django 4.2.17 on 2025-01-29 12:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'در انتظار پرداخت'), (2, 'درحال پردازش'), (3, 'ارسال شده'), (4, 'تحویل شده'), (5, 'لفو شده')], default=1)),
                ('address', models.CharField(max_length=250)),
                ('state', models.CharField(max_length=50)),
                ('city', models.CharField(max_length=50)),
                ('zip_code', models.CharField(max_length=50)),
